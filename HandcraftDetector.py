...
class HandcraftDetector(object):
    ...
    def __call__(self, image):
        ...
        print(type(keypoints), type(scores), type(desc))
...
if __name__ == "__main__":
    ...
    img0 = cv2.imread("/home/zourz/work/Dataset/SLAM/KITTI/data_odometry_gray/dataset/sequences/00/image_0/000000.png")

    handcraft_detector = HandcraftDetector({"type": "ORB"})
    kptdesc = handcraft_detector(img0)

    print(kptdesc["keypoints"].shape)
    print(kptdesc["descriptors"])
